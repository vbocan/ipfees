...
namespace IPFees.Core.Repository
{
    public class JurisdictionRepository : IJurisdictionRepository
    {
        ...
        /// <remarks>
        /// A jurisdiction is an IPF source code file that is meant to be included by calling code, akin to the #include functionality of the C programming language.
        /// </remarks>
