...
namespace IPFees.Core.Data
{
    public class DataContext
    {
        ...
        public IMongoCollection<ServiceFeesDoc> ServiceFeesCollection { get; set; }
        ...
        public DataContext(string ConnectionString)
        {
            ...
            ServiceFeesCollection = Context.GetCollection<ServiceFeesDoc>(ServiceFeesDoc.CollectionName);
